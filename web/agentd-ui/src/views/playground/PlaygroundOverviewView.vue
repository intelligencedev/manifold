    ...
    <section class="grid gap-4 md:grid-cols-3">
      <article class="rounded-2xl border border-border/70 bg-surface p-4">
        ...
        <RouterLink
          ...
          class="mt-4 inline-flex text-sm text-accent hover:underline"
      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-2 truncate max-w-[240px]">
              {{ prompt.description || "—" }}
            </td>
          ...
          <tr v-if="store.promptsLoading">
            <td colspan="4" class="py-3 text-center text-subtle-foreground">
              Loading…
            </td>
          </tr>
          <tr v-else-if="recentPrompts.length === 0">
            <td colspan="4" class="py-3 text-center text-subtle-foreground">
              No prompts yet.
            </td>
          </tr>
