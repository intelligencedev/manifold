<template>
  <div :class="['fixed top-[64px] bottom-0 w-64 z-[1100] transition-transform duration-300 text-white dark:bg-zinc-900 flex flex-col space-y-2 shadow-[5px_0_10px_-5px_rgba(0,0,0,0.3)]', isOpen ? 'translate-x-0' : '-translate-x-full']">
    <div class="absolute top-1/2 right-0 translate-x-full w-[30px] h-[60px] dark:bg-zinc-900 rounded-r-md flex items-center justify-center cursor-pointer shadow-[5px_0_10px_-5px_rgba(0,0,0,0.3)]" @click="togglePalette">
