...
func routeCatalog() []routeSpec {
	...
	routes = append(routes, routeCatalogPart1()...)
	routes = append(routes, routeCatalogPart2()...)
	routes = append(routes, routeCatalogPart3()...)
	routes = append(routes, routeCatalogPart4()...)
	routes = append(routes, routeCatalogPart5()...)
	routes = append(routes, routeCatalogPart6()...)
	routes = append(routes, routeCatalogPart7()...)
	routes = append(routes, routeCatalogPart8()...)
	routes = append(routes, routeCatalogPart9()...)
	routes = append(routes, routeCatalogPart10()...)
	routes = append(routes, routeCatalogPart11()...)
	routes = append(routes, routeCatalogPart12()...)
...
func routeCatalogPart1() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart2() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart3() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart4() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart5() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart6() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart7() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart9() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart10() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart11() []routeSpec {
	return []routeSpec{
...
func routeCatalogPart12() []routeSpec {
	return []routeSpec{
