...
For the full deployment walkthrough, see [QUICKSTART.md](./QUICKSTART.md) and [docs/deployment.md](./docs/deployment.md).
...
For deployment details, optional auth, storage behavior, observability, and troubleshooting, see:
