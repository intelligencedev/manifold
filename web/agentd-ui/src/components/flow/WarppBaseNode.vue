<template>
  ...
  >
    ...
    <div class="relative h-full w-full" :class="flipCardClasses">
      ...
      <!-- Front face -->
      <div class="flip-face flip-front rounded-lg border border-border/60 bg-surface/90 p-3 shadow-lg">
        <slot name="front" />
      </div>

      <!-- Back face -->
      <div class="flip-face flip-back rounded-lg border border-border/60 bg-surface/90 p-3 shadow-lg">
        <slot name="back" />
      </div>
    </div>
  </div>
