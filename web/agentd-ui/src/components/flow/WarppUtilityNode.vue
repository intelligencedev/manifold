        ...
        <div class="flex-1 space-y-2 overflow-auto">
          ...
          <label class="flex flex-col gap-1 text-[11px] text-muted-foreground">
            <div class="flex items-center justify-between gap-2">
              <span>{{
                isAgentResponse ? "Response Content" : "Textbox Content"
              }}</span>
              <div
            ...
            >
              <template v-if="isAgentResponse">
                <div
                  v-if="hasDisplayText"
                  class="h-full overflow-auto pr-1 space-y-1"
                >
                  <pre
                    v-if="renderMode === 'raw'"
                ...
                <span v-else class="block">
                  {{
                    runtimeStatus === "pending"
                      ...
                      : "Run the workflow to see rendered text."
                  }}
                </span>
              </template>
              <template v-else>
          ...
          >
            <div
              class="flex items-center justify-between text-[10px] uppercase tracking-wide text-faint-foreground"
            >
              <span>Preview</span>
            ...
            <div class="mt-1 max-h-[140px] overflow-auto pr-1 space-y-1">
              ...
              <p v-else class="text-[10px] text-faint-foreground">
                Add content to see a live preview.
              </p>
            </div>
          </div>
          <p
            v-if="runtimeStatus === 'pending'"
            class="text-[10px] italic text-faint-foreground"
          >
            Waiting for execution…
          </p>
          <p
            v-else-if="runtimeStatusMessage"
            class="text-[10px] italic text-faint-foreground"
          >
...
function applyCollapsedStyle(next: boolean) {
  ...
  const nextData = {
    ...(props.data ?? ({ kind: "utility", order: 0 } as any)),
    collapsed: next,
  };
