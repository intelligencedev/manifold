	...
	return map[string]any{
		...
		"parameters": map[string]any{
			...
			"properties": map[string]any{
				...
				"instruction":     map[string]any{"type": "string", "description": "Optional instruction task description applied to the query at embedding time (we will format as 'Instruct: {instruction}\\nQuery: {query}')"},
