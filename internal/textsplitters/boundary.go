...
func newSentenceSplitter(cfg BoundaryConfig) (Splitter, error) { return &boundarySplitter{mode: "sent", cfg: cfg}, nil }
func newParagraphSplitter(cfg BoundaryConfig) (Splitter, error) { return &boundarySplitter{mode: "para", cfg: cfg}, nil }
func newHybridSplitter(cfg BoundaryConfig) (Splitter, error) { return &boundarySplitter{mode: "hybrid", cfg: cfg}, nil }
...
func newRollingSentenceSplitter(cfg RollingConfig) (Splitter, error) { return &rollingSentenceSplitter{cfg: cfg}, nil }
