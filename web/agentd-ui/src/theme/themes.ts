...
export const themes: ThemeDefinition[] = [
  // Observability — Dark Glass
  {
    ...
    description:
      "Glass dashboard aesthetic with grid glow, crisp strokes, and dual accents.",
    appearance: "dark",
    tokens: {
      background: "6 8 12",
      surface: "14 18 26",
  ...
  // Aperture — Dark
  {
    ...
    label: "Aperture (Dark)",
    description:
      "Warm near-black neutrals with Iris primary, hairline strokes, and quiet contrast.",
    appearance: "dark",
    tokens: {
      background: "7 9 12",
      surface: "20 24 30",
  ...
  // Aperture — Light
  {
    ...
    description:
      "Editorial warm neutrals, Iris primary, 1.5px hairlines, and etched materials.",
    appearance: "light",
    tokens: {
