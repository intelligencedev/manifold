...
func (s *Service) Create(ctx context.Context, body string, createdBy int64) (Version, error) {
	return s.store.Create(ctx, body, createdBy)
}
func (s *Service) Activate(ctx context.Context, id string) (Version, error) {
	return s.store.Activate(ctx, id)
}
func (s *Service) GetActive(ctx context.Context) (Version, bool, error) {
